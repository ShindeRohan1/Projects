...
def CopyFiles(Path_1,Path_2,Extention):
        ...
        for foldername, subfolder, filenames in os.walk(Path_1):
            for fname in filenames:
                ...
                if os.path.isfile(source):
                    result = os.path.splitext(source)
...
def main():
    ...
    if(argv[1] == "-h" or argv[1] == "-H"):
        print("This script will travel and copy specified files from the given first  directory to second")
        exit()
    
    if(argv[1] == "-u" or argv[1] == "-U"):
        print("Usage : application, name first directory name, second directory name,File Extention ")
        exit()
